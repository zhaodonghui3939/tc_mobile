...
class UserFeatures(data: RDD[(String, Array[UserRecord])], begin: String, end: String) extends Serializable {
  ...
  private def calUserFeatures(featuresData: Array[UserRecord]) = {
    //用户的总的点击购买收藏和购物车
